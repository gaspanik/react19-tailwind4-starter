---
description: Figma URLのデザインをReact + Tailwind CSS v4で実装する
tools:
  - search/codebase
  - edit/editFiles
...
プロジェクトの [copilot-instructions.md](../copilot-instructions.md) のガイドラインに厳密に従って実装すること。
...
- `ComponentProps<'button'>` 等を使って既存HTML属性を継承する
