---
description: 実装済みコンポーネントをリファクタリングして再利用性と保守性を高める
tools:
  - search/codebase
  - edit/editFiles
...
プロジェクトの [copilot-instructions.md](../copilot-instructions.md) の「Component Patterns」セクションに従い、各コンポーネントに最適なアプローチを選択する：
